...
threshold = 200
test_size = 0.1
data_path = 'haochi_ai/data_scripts/full_dataset.csv'
...
dish_count_df.to_csv('haochi_ai/data_scripts/dish_id_count.csv', index=False)
...
train_data.to_csv('haochi_ai/data_scripts/train_data.csv', index=False)
test_data.to_csv('haochi_ai/data_scripts/test_data.csv', index=False)
